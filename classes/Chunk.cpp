...
std::map<glm::vec3, std::set<LightNode, LightNodeComparator>, VectorComparator> UnloadedLightQueue;
std::map<glm::vec3, std::map<glm::vec3, std::pair<int, int>, VectorComparator>, VectorComparator> ChangedBlocks;
